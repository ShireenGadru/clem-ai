...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col items-center ">
      <div className="flex-1 flex flex-col items-center justify-center w-1/2 gap-10">
        <div className="flex items-center gap-5 opacity-50">
          <img src="/logo.png" alt="" className="w-16 h-16" />
          <h1 className="text-[72px] font-bold bg-gradient-to-r from-green-400 to-emerald-600 bg-clip-text text-transparent ">
            CLEM AI
          </h1>
        </div>
      ...
      <div className="mt-auto w-1/2 bg-[#131619] flex rounded-[20px] mb-20 border border-white/40">
        <form
          action=""
